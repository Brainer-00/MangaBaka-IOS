...
class GeneralSettingsDialogs {
  static String getAppStartPageName(AppStartPage page) {
    ...
    switch (page) {
      case AppStartPage.home:
        return l10n.translate('start_page_home');
      case AppStartPage.library:
        return l10n.translate('start_page_library');
      case AppStartPage.browse:
        return l10n.translate('start_page_browse');
      case AppStartPage.news:
        return l10n.translate('start_page_news');
      case AppStartPage.profile:
        return l10n.translate('start_page_profile');
    }
  }
  ...
  static String getTitleLanguageName(TitleLanguage lang) {
    ...
    switch (lang) {
      case TitleLanguage.defaultLang:
        return l10n.translate('title_language_default');
      case TitleLanguage.native:
        return l10n.translate('title_language_native');
      case TitleLanguage.romanized:
        return l10n.translate('title_language_romanized');
    }
  }
  ...
  static void showLanguageSelectionDialog(BuildContext context) {
    ...
    SelectionBottomSheet.showSelectionBottomSheet<String>(
      ...
      getLabel: (code) =>
          languages.firstWhere((l) => l['code'] == code)['native_name']
              as String,
      onSelected: (code) {
  ...
  static String getLandscapeAppBarPositionName(
  ...
  static void showLandscapeAppBarPositionDialog(BuildContext context) {
    ...
    SelectionBottomSheet.showSelectionBottomSheet<LandscapeAppBarPosition>(
      ...
      onSelected: (position) =>
          SettingsManager().setLandscapeAppBarPosition(position),
    );
  }
}
